...
void swapv(int x, int y)
{
    ...
    printf("Inside swapv() - After swapping:\n");
    printf("x = %d, y = %d\n", x, y);
}
...
void swapr(int *x, int *y)
{
    ...
    *y = temp;
    ...
    printf("Inside swapr() - After swapping:\n");
    printf("a = %d, b = %d\n", *x, *y);
}
...
int main()
{
    ...
    printf("Before swapv() call:\n");
    printf("a = %d, b = %d\n\n", a, b);

    swapv(a, b);

    printf("After swapv() call:\n");
    printf("a = %d, b = %d\n\n", a, b);

    printf("Before swapr() call:\n");
    printf("a = %d, b = %d\n\n", a, b);

    swapr(&a, &b);

    printf("After swapr() call:\n");
    printf("a = %d, b = %d\n", a, b);
...
```
# Output:
<img width="1704" height="678" alt="image" src="https://github.com/user-attachments/assets/584ecfad-5a4d-41f3-918d-23de9f7e3c5a" />
...
```
# Output:
<img width="1691" height="678" alt="image" src="https://github.com/user-attachments/assets/dfcb6fcf-08a0-45aa-94f1-044ddb34bcc3" />
...
```
# Output:
<img width="1698" height="637" alt="image" src="https://github.com/user-attachments/assets/1d092045-d494-444c-93f7-708157042aca" />
...
```
# Output:
<img width="1702" height="674" alt="image" src="https://github.com/user-attachments/assets/9b1ea122-fb17-4454-9c6e-e265a6acd936" />
...
```
# Output: <img width="1690" height="637" alt="image" src="https://github.com/user-attachments/assets/13a6ee08-98b4-458e-825c-eb39fd4b5e7b" />
